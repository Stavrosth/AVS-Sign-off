...
PROC_INFO = {
    "tt": {
        "include": INCLUDE_TT, "vmin": Decimal("1.08"), "vmax": Decimal("1.32"), "suffix": "tt",
    },
    "ff": {
        "include": INCLUDE_FF, "vmin": Decimal("0.96"), "vmax": Decimal("1.2"), "suffix": "ff",
    },
    "ss": {
        "include": INCLUDE_SS, "vmin": Decimal("1.2"), "vmax": Decimal("1.44"), "suffix": "ss",
    },
}
